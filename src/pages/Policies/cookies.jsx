    ...
    return (
      <div className="docBody" id="privacyAndCookiePolicyRoot">
        ...
        <p>
          ...
          David Wheatley, the owner and provider of this Website. David Wheatley
            ...
            <table className="definitions">
              <tbody>
                <tr>
                  ...
                  <td>
                    collectively all information that you submit to David
                    Wheatley via the Website. This definition incorporates,
                ...
                <tr>
                  ...
                  <td>
                    ...
                    (i) employed by David Wheatley and acting in the course of
                    their employment or (ii) engaged as a consultant or
                    otherwise providing services to David Wheatley and accessing
                ...
                <tr>
                  ...
                  <td>
                    ...
                    https://wear24rom.com, and any sub-domains of this site
        ...
        <ol className="clauses">
          ...
          <li>
            For purposes of the applicable Data Protection Laws, David Wheatley
            is the "data controller". This means that David Wheatley determines
        ...
        <ol className="clauses">
          ...
          <li>
            We may use your Data to show you David Wheatley adverts and other
            content on other websites. If you do not want us to use your data to
            show you David Wheatley adverts and other content on other websites,
        ...
        <ol className="clauses">
          <li>
            ...
            <ol>
              <li>
                our employees, agents and/or professional advisors - to aid with
                support requests; facilitate account management; and manage
              ...
              <li>
                ...
                functions on our behalf to help ensure the website runs smoothly
                and maintains the highest uptime possible;
              </li>
              <li>
                relevant authorities - to report crime and facilitate the
                detection of crime;
              </li>
              <p>in each case, in accordance with this privacy policy.</p>
            </ol>
        ...
        <ol className="clauses">
          ...
          <li>
            ...
            contacting us via this e-mail address: davidwheatley03@gmail.com.
            <br />
          </li>
          <li>
        ...
        <ol className="clauses">
          ...
          <li>
            ...
            this e-mail address: davidwheatley03@gmail.com.
            <br />
          </li>
          <li>
        ...
        <ol className="clauses">
          <li>
            ...
            in a country outside the EEA. We also share information with our
            group companies, some of which are located outside the EEA.
          </li>
          <li>
          ...
          <li>
            ...
            we have put in place appropriate safeguards and procedures with the
            third parties we share your Data with. This ensures your Data is
            treated by those third parties in a way that is consistent with the
        ...
        <ol className="clauses">
          <li>
            ...
            or part of David Wheatley. Data provided by Users will, where it is
        ...
        <ol className="clauses">
          <li>
            ...
            Website. David Wheatley has carefully chosen these Cookies and has
          ...
          <li>
            ...
            enabling David Wheatley to provide a better experience and service
        ...
        <ol className="clauses">
          <li>
            ...
            <br />
            <br />
            You may contact David Wheatley by email at
        ...
        <table className="withBorders">
          <tbody>
            ...
            <tr>
              ...
              <td valign="top" align="left">
                We use this cookie to record whether you have consented to the
                collection of cookies or not.
              </td>
            </tr>
            <tr>
              <td valign="top" align="left">
                Cloudflare Unique Identifier
              </td>
              <td valign="top" align="left">
                We use this identifier to allow caching of pages to improve
        ...
        <table className="withBorders">
          <tbody>
            ...
            <tr>
              ...
              <td valign="top" align="left">
                We use this cookie to analyse how users use the site, their
                engagement on pages and where they came from.
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="withBorders">
          <tbody>
            ...
            <tr>
              ...
              <td valign="top" align="left">
                We use this cookie to remember the theme you have selected on
                our website.
              </td>
            </tr>
          </tbody>
        ...
        <table className="withBorders">
          <tbody>
            ...
            <tr>
              ...
              <td valign="top" align="left">
                We use this cookie to show your adverts while you use our
                website and others online.
              </td>
            </tr>
          </tbody>
        </table>
